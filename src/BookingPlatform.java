    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            if (input.equals("1")) {
                ...
                System.out.print("Enter date and time (dd/MM/yyyy HH:mm AM/PM): ");
                ...
                if (sessionChoice.equals("1")) {
                    ...
                    session = new SubjectSession(student, mentor, dateAndTime, subject);

                } else if (sessionChoice.equals("2")) {
                    System.out.print("Enter coaching topic: ");
                    String topic = sc.nextLine();
                    session = new CareerSession(student, mentor, dateAndTime, topic);
